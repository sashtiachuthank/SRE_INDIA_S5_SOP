...
This repository contains the source code for SRE guide and reference material website. The website was built using mkdocs, a user-friendly tool that allows non-programmers to create professional-looking websites using simple text files and pre-designed templates.
